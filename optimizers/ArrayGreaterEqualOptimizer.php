...
class ArrayGreaterEqualOptimizer extends OptimizerAbstract
{
    /**
    ...
    public function optimize(array $expression, Call $call, CompilationContext $context)
    {
        ...
        if (count($expression['parameters']) !== 2) {
            throw new CompilerException(
                'ArrayGreaterEqual only accepts two arguments.',
                $expression
            );
        }
        ...
        $context->codePrinter->output(
            'tensor_array_greater_equal(' . $symbol . ', ' . $resolvedParams[0] . ', ' . $resolvedParams[1] . ');'
        );
