...
if test "$PHP_TENSOR" = "yes"; then
	...
	PHP_INSTALL_HEADERS([ext/tensor], [tensor/tensor.zep.h tensor/vector.zep.h tensor/columnvector.zep.h tensor/matrix.zep.h tensor/0__closure.zep.h])
