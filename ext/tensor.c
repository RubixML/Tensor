...
zend_class_entry *tensor_0__closure_ce;
...
static PHP_RINIT_FUNCTION(tensor)
{
	...
	php_zephir_init_globals(tensor_globals_ptr TSRMLS_CC);
	zephir_initialize_memory(tensor_globals_ptr TSRMLS_CC);
...
{
	php_zephir_init_globals(tensor_globals TSRMLS_CC);
	php_zephir_init_module_globals(tensor_globals TSRMLS_CC);
}
