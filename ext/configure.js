...
configure_module_dirname = condense_path(FSO.GetParentFolderName('.\\config.w32'));
/* ARG_ENABLE("tensor", "enable tensor", "no"); */
...
if (PHP_TENSOR != "no") {
  ...
  ADD_SOURCES(configure_module_dirname + "/tensor", "tensor.zep.c vector.zep.c columnvector.zep.c matrix.zep.c", "tensor");
