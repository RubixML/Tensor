...
ZEPHIR_INIT_FUNCS(tensor_tensor_method_entry) {
	...
	PHP_ABSTRACT_ME(Tensor_Tensor, asin, NULL)
	PHP_ABSTRACT_ME(Tensor_Tensor, cos, NULL)
	PHP_ABSTRACT_ME(Tensor_Tensor, acos, NULL)
	PHP_ABSTRACT_ME(Tensor_Tensor, tan, NULL)
	PHP_ABSTRACT_ME(Tensor_Tensor, atan, NULL)
	PHP_ABSTRACT_ME(Tensor_Tensor, rad2deg, NULL)
	PHP_ABSTRACT_ME(Tensor_Tensor, deg2rad, NULL)
