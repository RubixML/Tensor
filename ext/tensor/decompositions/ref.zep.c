...
PHP_METHOD(Tensor_Decompositions_Ref, decompose) {
	...
	/* try_start_1: */
		...
		ZEPHIR_STATIC_RETURN_CALL_INTERNAL_METHOD_P1(tensor_decompositions_ref_ce, zep_Tensor_Decompositions_Ref_gaussianElimination_zephir_internal_call, a);
	...
	if (EG(exception)) {
		...
		if (zephir_instance_of_ev(&_0, spl_ce_RuntimeException)) {
			...
			ZEPHIR_STATIC_RETURN_CALL_INTERNAL_METHOD_P1(tensor_decompositions_ref_ce, zep_Tensor_Decompositions_Ref_rowReductionMethod_zephir_internal_call, a);
