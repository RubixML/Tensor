...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_decompositions_svd_decompose, 0, 1, IS_OBJECT, "Tensor\\Decompositions\\Svd", 0)
#endif
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_decompositions_svd_u, 0, 0, IS_OBJECT, "Tensor\\Matrix", 0)
#endif
ZEND_END_ARG_INFO()
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_decompositions_svd_singularvalues, 0, 0, IS_ARRAY, NULL, 0)
#endif
ZEND_END_ARG_INFO()
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_decompositions_svd_s, 0, 0, IS_OBJECT, "Tensor\\Matrix", 0)
#endif
ZEND_END_ARG_INFO()
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_decompositions_svd_v, 0, 0, IS_OBJECT, "Tensor\\Matrix", 0)
#endif
ZEND_END_ARG_INFO()
...
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_decompositions_svd_vt, 0, 0, IS_OBJECT, "Tensor\\Matrix", 0)
#endif
ZEND_END_ARG_INFO()
