...
ZEPHIR_INIT_CLASS(Tensor_Tensor) {
	...
	zend_class_implements(tensor_tensor_ce TSRMLS_CC, 1, zend_ce_arrayaccess);
	zend_class_implements(tensor_tensor_ce TSRMLS_CC, 1, zend_ce_aggregate);
	zend_class_implements(tensor_tensor_ce TSRMLS_CC, 1, spl_ce_Countable);
	return SUCCESS;
