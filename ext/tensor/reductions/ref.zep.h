...
extern ZEPHIR_API zend_class_entry *tensor_reductions_ref_ce;
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tensor_reductions_ref_gaussianelimination, 0, 1, Tensor\\Reductions\\Ref, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_reductions_ref_gaussianelimination, 0, 1, IS_OBJECT, "Tensor\\Reductions\\Ref", 0)
#endif
	ZEND_ARG_OBJ_INFO(0, a, Tensor\\Matrix, 0)
ZEND_END_ARG_INFO()

#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tensor_reductions_ref_rowreductionmethod, 0, 1, Tensor\\Reductions\\Ref, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_reductions_ref_rowreductionmethod, 0, 1, IS_OBJECT, "Tensor\\Reductions\\Ref", 0)
#endif
	ZEND_ARG_OBJ_INFO(0, a, Tensor\\Matrix, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(tensor_reductions_ref_method_entry) {
	...
	PHP_ME(Tensor_Reductions_Ref, gaussianElimination, arginfo_tensor_reductions_ref_gaussianelimination, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Tensor_Reductions_Ref, rowReductionMethod, arginfo_tensor_reductions_ref_rowreductionmethod, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
