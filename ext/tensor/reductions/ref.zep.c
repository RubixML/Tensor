...
PHP_METHOD(Tensor_Reductions_Ref, gaussianElimination) {
	...
	zval *a, a_sub, diag, scale, temp, _0, _1, _2, _4, _5, _6, _42, _20$$3, _21$$3, _26$$3, _13$$4, _14$$4, _15$$4, _17$$4, _18$$4, _19$$4, _22$$6, _25$$7, _30$$8, _31$$8, _41$$8, _35$$9, _36$$9, _37$$9, _38$$9, _39$$9, _40$$9;
	zval *this_ptr = getThis();
		...
		while (1) {
			...
			if (_11$$3 <= _12$$3) {
				while (1) {
					...
					i = _11$$3;
					zephir_array_fetch_long(&_13$$4, &b, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 76);
					zephir_array_fetch_long(&_14$$4, &_13$$4, k, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 76);
					ZEPHIR_CALL_FUNCTION(&_15$$4, "abs", &_16, 12, &_14$$4);
					zephir_check_call_status();
					zephir_array_fetch_long(&_17$$4, &b, index, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 76);
					zephir_array_fetch_long(&_18$$4, &_17$$4, k, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 76);
			...
			zephir_array_fetch_long(&_20$$3, &b, index, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 81);
			zephir_array_fetch_long(&_21$$3, &_20$$3, k, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 81);
			if (UNEXPECTED(ZEPHIR_IS_LONG(&_21$$3, 0))) {
				...
				zephir_check_call_status();
				zephir_throw_exception_debug(&_22$$6, "tensor/reductions/ref.zep", 83);
				ZEPHIR_MM_RESTORE();
				return;
			}
			if (k != index) {
				ZEPHIR_OBS_NVAR(&temp);
				zephir_array_fetch_long(&temp, &b, k, PH_NOISY, "tensor/reductions/ref.zep", 87);
				zephir_array_fetch_long(&_25$$7, &b, index, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 89);
			...
			zephir_array_fetch_long(&_26$$3, &b, k, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 95);
			ZEPHIR_OBS_NVAR(&diag);
			zephir_array_fetch_long(&diag, &_26$$3, k, PH_NOISY, "tensor/reductions/ref.zep", 95);
			_29$$3 = (m - 1);
			_28$$3 = (k + 1);
			_27$$3 = 0;
			if (_28$$3 <= _29$$3) {
				while (1) {
					...
					i = _28$$3;
					if (!ZEPHIR_IS_LONG_IDENTICAL(&diag, 0.0)) {
						zephir_array_fetch_long(&_30$$8, &b, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 98);
						zephir_array_fetch_long(&_31$$8, &_30$$8, k, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 98);
					...
					if (_33$$8 <= _34$$8) {
						while (1) {
							...
							j = _33$$8;
							zephir_array_fetch_long(&_35$$9, &b, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 101);
							zephir_array_fetch_long(&_36$$9, &_35$$9, j, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 101);
							zephir_array_fetch_long(&_37$$9, &b, k, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 101);
							zephir_array_fetch_long(&_38$$9, &_37$$9, j, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 101);
	...
	zephir_check_call_status();
	ZVAL_LONG(&_4, swaps);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 33, &_42, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Tensor_Reductions_Ref, rowReductionMethod) {
	...
	while (1) {
		...
		zephir_array_fetch_long(&_5$$3, &b, row, PH_NOISY, "tensor/reductions/ref.zep", 137);
		zephir_get_arrval(&_6$$3, &_5$$3);
		ZEPHIR_CPY_WRT(&t, &_6$$3);
		zephir_array_fetch_long(&_7$$3, &t, col, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 139);
		if (ZEPHIR_IS_LONG(&_7$$3, 0)) {
			...
			if (_9$$4 <= _10$$4) {
				while (1) {
					...
					i = _9$$4;
					zephir_array_fetch_long(&_11$$5, &b, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 141);
					zephir_array_fetch_long(&_12$$5, &_11$$5, col, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 141);
					if (!ZEPHIR_IS_LONG(&_12$$5, 0)) {
						ZEPHIR_OBS_NVAR(&temp);
						zephir_array_fetch_long(&temp, &b, i, PH_NOISY, "tensor/reductions/ref.zep", 142);
		...
		zephir_array_fetch_long(&_13$$3, &t, col, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 154);
		if (ZEPHIR_IS_LONG(&_13$$3, 0)) {
			col++;
			continue;
		}
		ZEPHIR_OBS_NVAR(&divisor);
		zephir_array_fetch_long(&divisor, &t, col, PH_NOISY, "tensor/reductions/ref.zep", 160);
		if (!ZEPHIR_IS_LONG_IDENTICAL(&divisor, 1.0)) {
			_16$$8 = (n - 1);
			_15$$8 = 0;
			_14$$8 = 0;
			if (_15$$8 <= _16$$8) {
				while (1) {
					...
					i = _15$$8;
					zephir_array_fetch_long(&_17$$9, &t, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 164);
		...
		if (_20$$3 <= _21$$3) {
			while (1) {
				...
				i = _20$$3;
				zephir_array_fetch_long(&_22$$10, &b, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 169);
				ZEPHIR_OBS_NVAR(&scale);
				zephir_array_fetch_long(&scale, &_22$$10, col, PH_NOISY, "tensor/reductions/ref.zep", 169);
				if (!ZEPHIR_IS_LONG_IDENTICAL(&scale, 0.0)) {
					_25$$11 = (n - 1);
					_24$$11 = 0;
					_23$$11 = 0;
					if (_24$$11 <= _25$$11) {
						while (1) {
							...
							j = _24$$11;
							zephir_array_fetch_long(&_26$$12, &b, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 173);
							zephir_array_fetch_long(&_27$$12, &_26$$12, j, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 173);
							zephir_array_fetch_long(&_28$$12, &t, j, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 173);
...
PHP_METHOD(Tensor_Reductions_Ref, __construct) {
	...
	if (UNEXPECTED(swaps < 0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/reductions/ref.zep", 197);
		ZEPHIR_MM_RESTORE();
		return;
	}
