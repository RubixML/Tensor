...
PHP_METHOD(Tensor_Reductions_Ref, gaussianElimination) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS, i = 0, j = 0, k = 0, index = 0, m, n, minDim, swaps, _8, _9, _11$$3, _12$$3, _28$$3, _29$$3, _33$$8, _34$$8;
	zval *a = NULL, a_sub, diag, scale, temp, _0, _1, _2, _3, _4, _5, _42, _20$$3, _21$$3, _26$$3, _13$$4, _14$$4, _15$$4, _17$$4, _18$$4, _19$$4, _22$$6, _25$$7, _30$$8, _31$$8, _41$$8, _35$$9, _36$$9, _37$$9, _38$$9, _39$$9, _40$$9;
	zval *this_ptr = getThis();
	...
	ZVAL_LONG(&_2, m);
	ZVAL_LONG(&_3, n);
	ZEPHIR_CALL_FUNCTION(&_4, "min", NULL, 19, &_2, &_3);
	zephir_check_call_status();
	minDim = zephir_get_intval(&_4);
	ZEPHIR_CALL_METHOD(&_5, a, "asarray", NULL, 0);
	zephir_check_call_status();
		...
		while (1) {
			...
			if (_11$$3 <= _12$$3) {
				while (1) {
					...
					j = _11$$3;
					zephir_array_fetch_long(&_13$$4, &b, j, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 79);
					zephir_array_fetch_long(&_14$$4, &_13$$4, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 79);
					ZEPHIR_CALL_FUNCTION(&_15$$4, "abs", &_16, 12, &_14$$4);
					zephir_check_call_status();
					zephir_array_fetch_long(&_17$$4, &b, index, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 79);
					zephir_array_fetch_long(&_18$$4, &_17$$4, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 79);
			...
			zephir_array_fetch_long(&_20$$3, &b, index, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 84);
			zephir_array_fetch_long(&_21$$3, &_20$$3, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 84);
			...
			if (i != index) {
				...
				zephir_array_fetch_long(&temp, &b, i, PH_NOISY, "tensor/reductions/ref.zep", 90);
				zephir_array_fetch_long(&_25$$7, &b, index, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 92);
				zephir_array_update_long(&b, i, &_25$$7, PH_COPY | PH_SEPARATE ZEPHIR_DEBUG_PARAMS_DUMMY);
				zephir_array_update_long(&b, index, &temp, PH_COPY | PH_SEPARATE ZEPHIR_DEBUG_PARAMS_DUMMY);
				swaps++;
			}
			zephir_array_fetch_long(&_26$$3, &b, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 98);
			ZEPHIR_OBS_NVAR(&diag);
			zephir_array_fetch_long(&diag, &_26$$3, i, PH_NOISY, "tensor/reductions/ref.zep", 98);
			_29$$3 = (m - 1);
			_28$$3 = (i + 1);
			_27$$3 = 0;
			if (_28$$3 <= _29$$3) {
				while (1) {
					...
					j = _28$$3;
					if (!ZEPHIR_IS_LONG(&diag, 0.0)) {
						zephir_array_fetch_long(&_30$$8, &b, j, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 101);
						zephir_array_fetch_long(&_31$$8, &_30$$8, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 101);
						ZEPHIR_INIT_NVAR(&scale);
						div_function(&scale, &_31$$8, &diag);
					} else {
						ZEPHIR_INIT_NVAR(&scale);
						ZVAL_DOUBLE(&scale, 1.0);
					}
					_34$$8 = (n - 1);
					_33$$8 = (i + 1);
					_32$$8 = 0;
					if (_33$$8 <= _34$$8) {
						while (1) {
							...
							k = _33$$8;
							zephir_array_fetch_long(&_35$$9, &b, j, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 104);
							zephir_array_fetch_long(&_36$$9, &_35$$9, k, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 104);
							zephir_array_fetch_long(&_37$$9, &b, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 104);
							zephir_array_fetch_long(&_38$$9, &_37$$9, k, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 104);
							ZEPHIR_INIT_NVAR(&_39$$9);
							mul_function(&_39$$9, &scale, &_38$$9);
							ZEPHIR_INIT_NVAR(&_40$$9);
							zephir_sub_function(&_40$$9, &_36$$9, &_39$$9);
							zephir_array_update_multi(&b, &_40$$9, SL("ll"), 2, j, k);
						}
					}
					ZEPHIR_INIT_NVAR(&_41$$8);
					ZVAL_DOUBLE(&_41$$8, 0.0);
					zephir_array_update_multi(&b, &_41$$8, SL("ll"), 2, j, i);
				}
			}
		}
	}
...
PHP_METHOD(Tensor_Reductions_Ref, rowReductionMethod) {
	...
	zval *a = NULL, a_sub, scale, divisor, temp, _0, _1, _2, _31, _33, _5$$3, _7$$3, _13$$3, _11$$5, _12$$5, _17$$9, _18$$9, _22$$10, _26$$12, _27$$12, _28$$12, _29$$12, _30$$12;
	zval *this_ptr = getThis();
	...
	while (1) {
		...
		zephir_array_fetch_long(&_5$$3, &b, row, PH_NOISY, "tensor/reductions/ref.zep", 142);
		zephir_get_arrval(&_6$$3, &_5$$3);
		ZEPHIR_CPY_WRT(&t, &_6$$3);
		zephir_array_fetch_long(&_7$$3, &t, col, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 144);
		if (ZEPHIR_IS_LONG(&_7$$3, 0)) {
			...
			if (_9$$4 <= _10$$4) {
				while (1) {
					...
					i = _9$$4;
					zephir_array_fetch_long(&_11$$5, &b, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 146);
					zephir_array_fetch_long(&_12$$5, &_11$$5, col, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 146);
					if (!ZEPHIR_IS_LONG(&_12$$5, 0)) {
						ZEPHIR_OBS_NVAR(&temp);
						zephir_array_fetch_long(&temp, &b, i, PH_NOISY, "tensor/reductions/ref.zep", 147);
		...
		zephir_array_fetch_long(&_13$$3, &t, col, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 159);
		if (ZEPHIR_IS_LONG(&_13$$3, 0)) {
			col++;
			continue;
		}
		ZEPHIR_OBS_NVAR(&divisor);
		zephir_array_fetch_long(&divisor, &t, col, PH_NOISY, "tensor/reductions/ref.zep", 165);
		if (!ZEPHIR_IS_LONG(&divisor, 1)) {
			...
			if (_15$$8 <= _16$$8) {
				while (1) {
					...
					i = _15$$8;
					zephir_array_fetch_long(&_17$$9, &t, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 169);
		...
		if (_20$$3 <= _21$$3) {
			while (1) {
				...
				i = _20$$3;
				zephir_array_fetch_long(&_22$$10, &b, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 174);
				ZEPHIR_OBS_NVAR(&scale);
				zephir_array_fetch_long(&scale, &_22$$10, col, PH_NOISY, "tensor/reductions/ref.zep", 174);
				if (!ZEPHIR_IS_LONG(&scale, 0)) {
					...
					if (_24$$11 <= _25$$11) {
						while (1) {
							...
							j = _24$$11;
							zephir_array_fetch_long(&_26$$12, &b, i, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 178);
							zephir_array_fetch_long(&_27$$12, &_26$$12, j, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 178);
							zephir_array_fetch_long(&_28$$12, &t, j, PH_NOISY | PH_READONLY, "tensor/reductions/ref.zep", 178);
...
PHP_METHOD(Tensor_Reductions_Ref, __construct) {
	...
	if (UNEXPECTED(swaps < 0)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "tensor/reductions/ref.zep", 202);
		ZEPHIR_MM_RESTORE();
		return;
	}
