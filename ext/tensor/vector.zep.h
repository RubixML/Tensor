...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tensor_vector_build, 0, 0, Tensor\\Vector, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_vector_build, 0, 0, IS_OBJECT, "Tensor\\Vector", 0)
#endif
	ZEND_ARG_ARRAY_INFO(0, a, 0)
ZEND_END_ARG_INFO()

#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tensor_vector_quick, 0, 0, Tensor\\Vector, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_vector_quick, 0, 0, IS_OBJECT, "Tensor\\Vector", 0)
#endif
	ZEND_ARG_ARRAY_INFO(0, a, 0)
ZEND_END_ARG_INFO()
