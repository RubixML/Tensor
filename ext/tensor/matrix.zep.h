...
ZEND_BEGIN_ARG_INFO_EX(arginfo_tensor_matrix___construct, 0, 0, 0)
	ZEND_ARG_ARRAY_INFO(0, a, 0)
#if PHP_VERSION_ID >= 70200
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tensor_matrix_degrees, 0, 0, Tensor\\Matrix, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_matrix_degrees, 0, 0, IS_OBJECT, "Tensor\\Matrix", 0)
#endif
ZEND_END_ARG_INFO()

#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tensor_matrix_radians, 0, 0, Tensor\\Matrix, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_matrix_radians, 0, 0, IS_OBJECT, "Tensor\\Matrix", 0)
#endif
ZEND_END_ARG_INFO()
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tensor_matrix_rowexclude, 0, 1, Tensor\\Matrix, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_matrix_rowexclude, 0, 1, IS_OBJECT, "Tensor\\Matrix", 0)
#endif
#if PHP_VERSION_ID >= 70200
	ZEND_ARG_TYPE_INFO(0, index, IS_LONG, 0)
#else
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tensor_matrix_columnexclude, 0, 1, Tensor\\Matrix, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_matrix_columnexclude, 0, 1, IS_OBJECT, "Tensor\\Matrix", 0)
#endif
#if PHP_VERSION_ID >= 70200
	ZEND_ARG_TYPE_INFO(0, index, IS_LONG, 0)
#else
...
#if PHP_VERSION_ID >= 70200
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tensor_matrix_repeat, 0, 0, Tensor\\Matrix, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tensor_matrix_repeat, 0, 0, IS_OBJECT, "Tensor\\Matrix", 0)
#endif
#if PHP_VERSION_ID >= 70200
	ZEND_ARG_TYPE_INFO(0, m, IS_LONG, 0)
#else
...
ZEPHIR_INIT_FUNCS(tensor_matrix_method_entry) {
	...
	PHP_ME(Tensor_Matrix, determinant, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Tensor_Matrix, degrees, arginfo_tensor_matrix_degrees, ZEND_ACC_PUBLIC)
	PHP_ME(Tensor_Matrix, radians, arginfo_tensor_matrix_radians, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Tensor_Matrix, rowExclude, arginfo_tensor_matrix_rowexclude, ZEND_ACC_PUBLIC)
	PHP_ME(Tensor_Matrix, columnExclude, arginfo_tensor_matrix_columnexclude, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Tensor_Matrix, multiplyMatrix, arginfo_tensor_matrix_multiplymatrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, divideMatrix, arginfo_tensor_matrix_dividematrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, addMatrix, arginfo_tensor_matrix_addmatrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, subtractMatrix, arginfo_tensor_matrix_subtractmatrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, powMatrix, arginfo_tensor_matrix_powmatrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, modMatrix, arginfo_tensor_matrix_modmatrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, equalMatrix, arginfo_tensor_matrix_equalmatrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, notEqualMatrix, arginfo_tensor_matrix_notequalmatrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, greaterMatrix, arginfo_tensor_matrix_greatermatrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, greaterEqualMatrix, arginfo_tensor_matrix_greaterequalmatrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, lessMatrix, arginfo_tensor_matrix_lessmatrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, lessEqualMatrix, arginfo_tensor_matrix_lessequalmatrix, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, multiplyVector, arginfo_tensor_matrix_multiplyvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, divideVector, arginfo_tensor_matrix_dividevector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, addVector, arginfo_tensor_matrix_addvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, subtractVector, arginfo_tensor_matrix_subtractvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, powVector, arginfo_tensor_matrix_powvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, modVector, arginfo_tensor_matrix_modvector, ZEND_ACC_PROTECTED)
	...
	PHP_ME(Tensor_Matrix, multiplyColumnVector, arginfo_tensor_matrix_multiplycolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, divideColumnVector, arginfo_tensor_matrix_dividecolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, addColumnVector, arginfo_tensor_matrix_addcolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, subtractColumnVector, arginfo_tensor_matrix_subtractcolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, powColumnVector, arginfo_tensor_matrix_powcolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, modColumnVector, arginfo_tensor_matrix_modcolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, equalColumnVector, arginfo_tensor_matrix_equalcolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, notEqualColumnVector, arginfo_tensor_matrix_notequalcolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, greaterColumnVector, arginfo_tensor_matrix_greatercolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, greaterEqualColumnVector, arginfo_tensor_matrix_greaterequalcolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, lessColumnVector, arginfo_tensor_matrix_lesscolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, lessEqualColumnVector, arginfo_tensor_matrix_lessequalcolumnvector, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, multiplyScalar, arginfo_tensor_matrix_multiplyscalar, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, divideScalar, arginfo_tensor_matrix_dividescalar, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, addScalar, arginfo_tensor_matrix_addscalar, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, subtractScalar, arginfo_tensor_matrix_subtractscalar, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, powScalar, arginfo_tensor_matrix_powscalar, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, modScalar, arginfo_tensor_matrix_modscalar, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, equalScalar, arginfo_tensor_matrix_equalscalar, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, notEqualScalar, arginfo_tensor_matrix_notequalscalar, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, greaterScalar, arginfo_tensor_matrix_greaterscalar, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, greaterEqualScalar, arginfo_tensor_matrix_greaterequalscalar, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, lessScalar, arginfo_tensor_matrix_lessscalar, ZEND_ACC_PROTECTED)
	PHP_ME(Tensor_Matrix, lessEqualScalar, arginfo_tensor_matrix_lessequalscalar, ZEND_ACC_PROTECTED)
